...
$price = $_POST['price'];
$delcab_cut = $_POST['delcab_cut'];
$driver_pay = $_POST['driver_pay'];
...
$statement = $conn->prepare("INSERT INTO package (business_id, business_name, start_ad, end_ad,
	start_lat, start_lon, end_lat, end_lon, price, delcab_cut, driver_pay, time_added) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");


$statement->bind_param("ssssssssssss", $business_id_prep, $business_name_prep, $start_ad_prep, $end_ad_prep, $start_lat_prep,
$start_lon_prep, $end_lat_prep, $end_lon_prep, $price_prep, $delcab_cut_prep, $driver_pay_prep, $time_added_prep);
...
$price_prep = $price;
$delcab_cut_prep = $delcab_cut;
$driver_pay_prep = $driver_pay;
